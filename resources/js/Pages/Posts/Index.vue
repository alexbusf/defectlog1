                              ...
                              <tbody>
                                <tr v-for="post in posts.data" :key="post.id">
                                  <!-- <td class="border px-4 py-2">
                                    <Link :href="route('postsByUser', post.user.id)" class="text-blue-500 hover:underline">
                                      {{ post.user.name }}
                                    </Link>
                                  </td> -->
                                  <td class="border px-4 py-2">
                                    <Link :href="route('postsByCategory', post.category.id)" class="text-blue-500 hover:underline">
                                      {{ post.category.title }}
                                    </Link>
                                  </td>
                                  <td class="border px-4 py-2">
